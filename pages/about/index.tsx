    ...
    <div className="flex flex-col items-center">
      <Card header="The software">
        <p className="mb-8">
          ...
          anyway you see fit. It's yours forever! The only ask is that if you
          make code improvements and want to release your own version, you make
          those changes also under the AGPL 3 license so that Vislit stays free
          forever.
        </p>
        <p>
          Vislit is developed using the Electron framework, which many well
          known companies use, like Slack, Discord, and Facebook. This allows
          for easy cross-platform development with a consistent user experience.
          It will also allow for more flexibilty in the future for say, a
          web-browser based version of Vislit.
        </p>
      </Card>
      ...
      <Card header="Special thanks">
        <p>
          ...
          projects available, namely: Electron, Vue, Node, TypeScript, Lowdb,
          and more.
        </p>
        <p className="my-8">
